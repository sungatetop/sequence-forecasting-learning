...
from core.models import predrnn, predrnn_v2,predrnn_v3,MAU,action_cond_predrnn, action_cond_predrnn_v2
...
class Model(object):
    ...
    def trainV3(self,frames,distance,mask):
        ...
        distance_tensor= torch.FloatTensor(distance).to(self.configs.device)
